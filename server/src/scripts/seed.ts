...
function seedCartItem(name: string, price: number, size = 'M', color = 'Multi') {
  return {
    product: {
      id: 'seed',
      name,
...
const seedOrders = [
  {
    ...
    items: [seedCartItem('Ananya Floral Block-Print Cotton Suit Set', 2499, 'M', 'Sage Green')],
    subtotal: 2499,
    discount: 0,
    shipping: 0,
    codFee: 0,
    ...
    address: { id: '1', name: 'Priya Sharma', phone: '9876543210', line1: 'Mumbai', city: 'Mumbai', state: 'MH', pincode: '400001', isDefault: true },
  },
  {
    id: 'SV002',
    date: '2025-12-14',
    ...
    items: [seedCartItem('Royal Banarasi Silk Saree', 5499, 'Free Size', 'Maroon')],
    subtotal: 5499,
    discount: 0,
    shipping: 0,
    codFee: 0,
    ...
    address: { id: '1', name: 'Ananya', phone: '9876543211', line1: 'Bangalore', city: 'Bangalore', state: 'KA', pincode: '560001', isDefault: true },
  },
  {
    id: 'SV003',
    date: '2025-12-14',
    ...
    items: [seedCartItem('Embroidered Georgette Lehenga Set', 6999, 'L', 'Rose Gold')],
    subtotal: 6999,
    discount: 0,
    shipping: 0,
    codFee: 0,
    total: 6999,
    paymentMethod: 'razorpay' as const,
    address: { id: '1', name: 'Meera', phone: '9876543212', line1: 'Mumbai', city: 'Mumbai', state: 'MH', pincode: '400002', isDefault: true },
  },
  {
    id: 'SV004',
    ...
    items: [seedCartItem('Bridal Zari Work Silk Saree', 14999, 'Free Size', 'Red')],
    subtotal: 14999,
    discount: 0,
    shipping: 0,
    codFee: 0,
    total: 14999,
    paymentMethod: 'cod' as const,
    address: { id: '1', name: 'Sunita', phone: '9876543213', line1: 'Hyderabad', city: 'Hyderabad', state: 'TS', pincode: '500001', isDefault: true },
  },
];
