    ...
    <section className="py-20 bg-cream-100">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <p className="font-body text-xs tracking-[0.25em] uppercase font-semibold text-rosegold-500 mb-3">{t('home.instagramOverline')}</p>
          <h2 className="font-heading text-3xl lg:text-4xl font-semibold text-navy-700 mb-2">@sitaravastram</h2>
          <p className="font-body text-sm text-gray-500 max-w-sm mx-auto" dangerouslySetInnerHTML={{ __html: t('home.instagramTagline') }} />
        </div>
        ...
        <div className="text-center mt-8">
          <a href={INSTAGRAM_PROFILE} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-body font-semibold text-navy-700 border border-navy-700 px-6 py-3 rounded-sm hover:bg-navy-700 hover:text-white transition-all duration-300">
