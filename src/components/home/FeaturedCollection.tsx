...
const features = [
  ...
  },
  {
    ...
    image: 'https://images.pexels.com/photos/17503287/pexels-photo-17503287.jpeg?auto=compress&cs=tinysrgb&w=900',
    ...
    <section className="py-20 bg-cream-100">
      <div className="w-full">
        <div className="text-center mb-16">
          ...
          <h2 className="font-heading text-4xl lg:text-5xl font-semibold text-navy-700">
            {t('home.featuredCollections')}
          </h2>
          <p className="font-body text-base text-gray-500 mt-4 max-w-xl mx-auto leading-relaxed">
            ...
            >
              <div className="relative group overflow-hidden rounded-sm shadow-luxury-lg">
                ...
                <div className="absolute top-6 left-6">
                  <span className="inline-block bg-white/90 backdrop-blur-sm text-navy-700 text-xs font-body font-semibold px-4 py-2 rounded-sm tracking-widest uppercase shadow-card">
                    {t(`featured.${feature.id}.tag`)}
                  </span>
                </div>
                <div className="absolute bottom-6 right-6">
                  <span className="inline-block bg-rosegold-500/90 backdrop-blur-sm text-white text-xs font-body font-medium px-3 py-1.5 rounded-sm">
              ...
              <div className="flex flex-col justify-center lg:px-6">
                <p className="font-body text-xs tracking-[0.3em] uppercase font-semibold text-rosegold-500 mb-4">
                  {t(`featured.${feature.id}.eyebrow`)}
                </p>
                <h3 className="font-heading text-3xl lg:text-4xl font-semibold text-navy-700 leading-tight mb-6 whitespace-pre-line">
